    ...
    <div class="shane_tm_hero" id="home" data-style="one">
      ...
      <div class="container">
        <div class="content">
          <div class="name_wrap">
            <h3>
              <span>Meilleur partenaire</span> <br />
...
export default {
  data() {
    return {
      sliderHero: require("../../assets/img/slider/slider-1.jpg"),
      typeValue: "",
      typeStatus: false,
      typeArray: ["Développement APP Web.", "Développement APP Mobiles.", "Conseil En Informatique"],
      typingSpeed: 200,
      erasingSpeed: 100,
      newTextDelay: 2000,
      typeArrayIndex: 0,
